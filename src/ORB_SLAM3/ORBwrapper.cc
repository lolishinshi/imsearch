...
extern "C" {
Result<void*> slam3_ORB_create(int nfeatures, float scaleFactor, int nlevels, int iniThFAST, int minThFAST) {
    try {
        return Ok<void*>(new ORB_SLAM3::ORBextractor(nfeatures, scaleFactor, nlevels, iniThFAST, minThFAST));
